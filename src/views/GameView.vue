  ...
  <div class="game-view" :class="{ mobile: isMobile, portrait: isPortrait }">
    ...
    <header class="game-header">
      ...
      <div class="header-right">
        ...
        <a class="github-link" href="https://github.com/Laurence-042/oral-oiiaioiiiai" target="_blank" rel="noopener noreferrer" title="GitHub">
...
.github-link:hover { color: #e6edf3; }
